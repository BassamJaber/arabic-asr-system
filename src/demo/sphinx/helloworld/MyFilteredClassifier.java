 ...
 */
 public class MyFilteredClassifier {
	...
	public void makeInstance() {
		...
		fvNominalVal.addElement("Œœ„« ");
		fvNominalVal.addElement("›Ê« Ì—");
		fvNominalVal.addElement("«Œ—Ï");
		Attribute attribute1 = new Attribute("class", fvNominalVal);
		Attribute attribute2 = new Attribute("article",(FastVector) null);
	...
	public String classify() {
		...
		try {
			for (int i = 0; i < instances.size(); i++) {
				...
				questionClass=instances.classAttribute().value((int) pred);
				System.out.println("Class predicted: " + questionClass);
			}
